               ...
               <div class="col-xl-2 colmod11" >
                   <nav2>
                       <ul>
                           ...
                           <form action=""><input type="submit" value="Albums"></form>
...
<!--******************************************************************************************************************** -->
<?php
            $result_alb = mysqli_query($conn,"SELECT * FROM album A JOIN artista B ON A.ArtistaAlb=B.id"); //Funciona
            //$result_alb = mysqli_query($conn, "SELECT * FROM $table");

            mysqli_data_seek ($result_alb, 0);
            $filas=mysqli_num_rows($result_alb);  echo "Filas:".$filas; echo "<hr>";
            ...
            <div id="encuadradatos2">
                <div class="formListado">
                    <form  name="formulario"  method="POST" action="#">
                     <input type="text" disabled readonly name="nom"    size="30" value="<?php echo $resultados['TituloAlb'];  ?>"/>
                     <input type="text" disabled readonly name="ImgArt" value="<?php echo $resultados['Nombre']; ?>"/>
                     <input type="text" disabled readonly name="ImgArt" value="<?php echo $resultados['Lanzamiento']; ?>"/>
                     <img    src="img/<?php echo $resultados['ImgPortada']?>" width="197px;" height="272px;">
                     <input type="text" disabled readonly name="ImgArt" value="<?php echo $resultados['Estilo']; ?>"/>
                     <br><br><br>
...
<?php
        ...
        while ($fila = mysqli_fetch_array($result_alb)){
        mostrarDatos3($fila);}
