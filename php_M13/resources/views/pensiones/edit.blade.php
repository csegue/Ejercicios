...
<!--............................................................................................................... -->
            ...
            <h3>MODIFICACION DE LA PENSION<h3>    
            <table>
            ...
            <table>
            <form action="{{route('pensiones.update', $pension)}}" method="post">            <!-- la ruta para modificar -->
                        <input type="hidden" name="_token" value="{{ csrf_token() }}"/>    @csrf
                        <input type="hidden" name="_method" value="PUT"/>       @method('put')
                        <tr>
                            <td><input style="background-color: white" type="text"  size="4px"   name="id"         value="{{$pension->id}}"></td>
                            <td><input style="background-color: white" type="text"  size="20px"  name="tipo_pen"   value="{{$pension->tipo_pen}}"></td>
