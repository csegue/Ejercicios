...
<!--............................................................................................................... -->
            ...
            <table>
                ...
                <form action="{{route('reservas.update', $reserva)}}" method="post">           
                            ...
                            <tr>
                                <td><input style="background-color: white" type="text"  size="4px"   name="id"          value="{{$reserva->id}}"></td>
                                <td><input style="background-color: white" type="date"  size="17px"  name="fecha_ent"   value="{{$reserva->fecha_ent}}"></td>
                                <td><input style="background-color: white" type="date"  size="17px"  name="fecha_sal"   value="{{$reserva->fecha_sal}}"></td>
                                ...
                                <td><input  type="text"  size="5px"  name="room_id" value="{{$reserva->id}}" disabled></td>
