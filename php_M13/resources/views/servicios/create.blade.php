...
<!--............................................................................................................... -->
            ...
            <form action="{{route('servicios.store')}}" method="POST">        
                <input type="hidden" name="_token" value="{{ csrf_token() }}" /> 
                    <tr>   
                        <td><input style="background-color: white" size=20px; type="text" name="tipo_serv" value="{{old('tipo_serv')}}"></td> 
                        <td><button type="submit">Enviar</button></td>
                    </tr>
            </form>
            </table>
                        <a class="btn btn-outline-primary btn-sm " href="{{route('servicios.listado')}}" role="button">Volver</a>
                        @error('tipo_serv')<small>*{{$message}}</small>@enderror
