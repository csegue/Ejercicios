...
?>
     <div id="especial">
        ...
        <form action="" method="POST">
          ...
          <input type="submit" name="yModif" value="Desea Eliminar ?">
          <input type="submit" name="yvolver" value="Volver Sin Eliminar">
    ...
    if(isset($_REQUEST['yModif']))
     {
         ...
         $obj=new metodos();
         if($obj->EliminarDatos($datos)==1){header("location: ./index.php");}
         session_unset();
