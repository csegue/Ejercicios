...
<?php
            echo "Crea una funció que compti fins a 10, de 2 en 2, mostrant cada número del compte per pantalla."."<br>";
...
<!--  formulario este ejercicio -->
      ...
      <div class="col-xl-9 colmod2" >  <!-- align-self-start -->
          <div class="CasillasForm text-center">
               <form  action="#" method="POST" autocomplete="">
                  <input name="tcuentados" type="number2"    required style="text-align: center;" placeholder= "Var-1"  value="" /></br>
