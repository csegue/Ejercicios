...
<?php
            ...
            if(isset($_POST['tingreso2'])){
                ...
                $choc1=operaciones($choc, 0, "Chocolates");
                $chic1=operaciones($chic, 0, "Chicles");
                $carm1=operaciones($carm, 0, "Caramelos");




                /*echo "Total ="." ".$choc1+$chic1+$carm1." "."€";*/
                echo "Total :";
                echo $choc1+$chic1+$carm1."€";
            }
...
<!--  formulario este ejercicio -->
      ...
      <div class="col-xl-9 colmod2" >  <!-- align-self-start -->
          ...
          <div class="CasillasForm text-center">
               <form  action="#" method="POST" autocomplete="">
                  <input name="tint1" type="number"    required style="text-align: center;" placeholder= "Chocolates"  value="" /></br>
                  <input name="tint2" type="number"    required style="text-align: center;" placeholder= "Chicles"  value="" /></br>
                  <input name="tint3" type="number"    required style="text-align: center;" placeholder= "Caramelos"  value="" /></br>
