  ...
  <div class="Mod1">
   <div class="row rowmod1">   <!-- d-block: los pone verticales -->
       ...
       <div class="col-xl-3 colmod1">
           <nav2>
                 <p> Seleccione o escriba Opción </p>
               <ul>
...
<!-- Calculo función -->
  ...
  <?php
            echo "Ejercicio 2 :Programa una lògica que, donat un número qualsevol(per exemple,la teva edat) ens digui si és parell o imparell mitjançant un missatge per pantalla."."<br><br>";
            echo "Ejercicio 3: Agafa la lògica de l'exercici 2 i encapsulala en una funció de nom parell_o_imparell. Invoca aquesta funció per a comprovar que funciona correctament."."<br><br>";


             if(isset($_POST['tingreso2'] )){ /* && !empty($_POST['tinteger']))*/
                 $xpar =  $_POST['tpar'];

                 $r = operaciones($xpar, 0, "Par");

                if($r==0){
                 ?><p class="result" style="font-weight: bold; color: "><?php echo "El número :"." ".$xpar."  "."es par";?><p><?php
             }else{
                 ?><p class="result" style="font-weight: bold; color: "><?php echo "El número :"." ".$xpar."  "."es impar";?><p><?php
             }
...
<!--  formulario este ejercicio -->
          ...
          <div class="col-xl-9 colmod2" >  <!-- align-self-start -->
              <div class="CasillasForm text-center">
                   <form  action="#" method="POST" autocomplete="">
                      <input name="tpar" type="number2"    required style="text-align: center;" placeholder= "Var-1"  value="" /></br>
    ...
    if(isset($_POST['tingreso'])) /* && !empty($_POST['tinteger']))*/
    {
        ...
        if($integer ==10 || $verificar==1){
            $valor2 = $integer;
                                            ...
                                            /*echo "Es mayor de 1 carácter y no es 10"."<br>";*/
            $valor2=substr($integer,1);
                                            /*echo "el carácter es :".$integer2; echo "<br>";*/
        }
