...
<!-- Calculo función -->
  ...
  <?php
            echo "Programa la funció resta que, donats dos paràmetres ens retorni la resta dels dos números."."<br><br>";

             if(isset($_POST['tingreso2'] )){ /* && !empty($_POST['tinteger']))*/
                 $xresta1 =  $_POST['tresta1'];
                 $xresta2 =  $_POST['tresta2'];

                 $r = operaciones($xresta1, $xresta2, "Restar");
                 ?><p class="result" style="font-weight: bold; color: "><?php echo "Resta :"." ".$xresta1." - ".$xresta2." : ".$r;?><p><?php
             }
           ?>
       </div>
...
<!--  formulario este ejercicio -->
          ...
          <div class="col-xl-9 colmod2" >  <!-- align-self-start -->
              <div class="CasillasForm text-center">
                   <form  action="#" method="POST" autocomplete="">
                      <input name="tresta1" type="number2"    required style="text-align: center;" placeholder= "Var-1"  value="" /></br>
                      <input name="tresta2" type="number3"    required style="text-align: center;" placeholder= "Var-2"  value="" /></br>
