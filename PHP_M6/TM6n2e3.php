...
<?php
            echo "Per a prevenir oblits al utilitzar la nostra meravellosa funció amagatall establirem un paràmetre per defecte a 10 en la funció que s'encarrega de fer aquest compte."."<br>";
